...
} catch (e) { logEvent('ERROR', 'Erro ao carregar VIPs/Pagamentos/Uso.'); }
...
function loadUserConfig(tid) {
    ...
    if (fs.existsSync(p)) {
        try {
            ...
            userConfigs[tid] = { texto: '👻!', quantidade: 5, delay: 1000, autoNick: false, antiKick: true };
        }
    } else {
        userConfigs[tid] = { texto: '👻!', quantidade: 5, delay: 1000, autoNick: false, texto_flood: '🔥', quantidade_flood: 10, antiKick: true };
    }
